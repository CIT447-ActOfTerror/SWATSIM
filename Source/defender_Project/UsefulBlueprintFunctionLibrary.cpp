...
#include "UsefulBlueprintFunctionLibrary.h"
#include "Engine/Engine.h" 

void UUsefulBlueprintFunctionLibrary::LogWarning(FString text)
{
	//Output Log
...
UActorComponent* UUsefulBlueprintFunctionLibrary::SpawnActorComponent(TSubclassOf<UActorComponent> componentClass, AActor* owner)
{
	if (!componentClass || !owner)
	{
		LogWarning("SpawnActorComponent class or owner was null");
		return nullptr;
	}
...
USceneComponent* UUsefulBlueprintFunctionLibrary::SpawnSceneComponent(TSubclassOf<USceneComponent> componentClass, AActor* owner, USceneComponent* attachTo)
{
	if (!componentClass || !owner)
	{
		LogWarning("SpawnSceneComponent class or owner was null");
		return nullptr;
	}
...
bool UUsefulBlueprintFunctionLibrary::HasComponent(const AActor* actor, const FName tag, const TSubclassOf<UActorComponent> componentClass)
{
	if (!actor)
		return false;
...
void UUsefulBlueprintFunctionLibrary::SortByBoundsSize(UPARAM(ref) TArray<AActor*>& arr)
{
